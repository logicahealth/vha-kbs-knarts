...
<xsl:stylesheet xmlns:exsl="http://exslt.org/common" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns="http://docbook.org/ns/docbook" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" exclude-result-prefixes="exsl">
...
<xsl:template name="book.titlepage.recto">
  ...
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="bookinfo/volumenum"/>
  <xsl:apply-templates mode="book.titlepage.recto.auto.mode" select="info/volumenum"/>
...
<xsl:template name="book.titlepage.verso">
  ...
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="bookinfo/mediaobject"/>
  <xsl:apply-templates mode="book.titlepage.verso.auto.mode" select="info/mediaobject"/>
...
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" space-before="2em">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="author" mode="book.titlepage.recto.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" font-size="14.4pt" space-before="1.5in" keep-with-next.within-column="always">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>

<xsl:template match="mediaobject[1]" mode="book.titlepage.recto.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" space-before="2em">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<fo:block xsl:use-attribute-sets="book.titlepage.recto.style" space-before="1em">
<xsl:apply-templates select="." mode="book.titlepage.recto.mode"/>
</fo:block>
</xsl:template>
...
<xsl:template match="mediaobject[2]" mode="book.titlepage.verso.auto.mode">
<fo:block xsl:use-attribute-sets="book.titlepage.verso.style">
<xsl:apply-templates select="." mode="book.titlepage.verso.mode"/>
</fo:block>
</xsl:template>
